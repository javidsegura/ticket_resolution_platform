...
async def get_company_profile_by_id(db: AsyncSession, profile_id: int) -> Optional[CompanyProfile]:
    """
...
async def get_all_company_profiles(db: AsyncSession, skip: int = 0, limit: int = 100) -> List[CompanyProfile]:
    """
